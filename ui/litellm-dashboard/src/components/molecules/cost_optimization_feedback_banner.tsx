  ...
  return (
    <div className="mb-4 px-4 py-3 bg-blue-50 rounded-lg border border-blue-100 flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        <h4 className="text-gray-900 font-semibold text-sm m-0">{t("costOptimizationBanner.title")}</h4>
        <p className="text-gray-500 text-xs m-0 mt-0.5">{t("costOptimizationBanner.description")}</p>
      </div>
      <a
        href={DISCUSSION_URL}
        target="_blank"
      ...
      <button
        ...
        aria-label={t("costOptimizationBanner.dismiss")}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5"

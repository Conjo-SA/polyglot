/** A single MCP tool event emitted by the Polyglot proxy during a Responses API turn. */
...
// verbatim for true_passthrough, alongside Polyglot admission for oauth_delegate). The dashboard holds

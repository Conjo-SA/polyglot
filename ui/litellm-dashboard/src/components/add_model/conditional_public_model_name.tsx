...
const ConditionalPublicModelName: React.FC = () => {
  ...
  const publicNameTooltipContent = (
    <>
      <div className="mb-2 font-normal">The name you specify in your API calls to Polyglot Proxy</div>
      <div className="mb-2 font-normal">
        ...
        <code className="bg-gray-700 px-1 py-0.5 rounded-sm text-xs">openai/qwen-plus-latest</code> as the Polyglot model
      </div>
      <div className="mb-2 font-normal">
        <strong>Usage:</strong> You make an API call to the Polyglot proxy with{" "}
        <code className="bg-gray-700 px-1 py-0.5 rounded-sm text-xs">model = &quot;example-name&quot;</code>
      </div>
      <div className="font-normal">
        <strong>Result:</strong> Polyglot sends{" "}
        <code className="bg-gray-700 px-1 py-0.5 rounded-sm text-xs">qwen-plus-latest</code> to the provider
      </div>
    </>
  );

  const liteLLMModelTooltipContent = <div>The model name Polyglot will send to the LLM API</div>;
  ...
  return (
    <>
      <Form.Item
        ...
        name="model_mappings"
        tooltip="Map public model names to Polyglot model names for load balancing"
        labelCol={{ span: 10 }}
        wrapperCol={{ span: 16 }}
        labelAlign="left"
        rules={[

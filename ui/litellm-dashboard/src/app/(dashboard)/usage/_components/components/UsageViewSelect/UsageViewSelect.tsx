...
const OPTIONS: OptionConfig[] = [
  {
    value: "global",
    label: "Uso Global",
    showForAdmin: "Uso Global",
    showForNonAdmin: "Seu Uso",
    description: "Visualizar uso em todos os recursos",
    descriptionForAdmin: "Visualizar uso em todos os recursos",
    descriptionForNonAdmin: "Visualizar seu uso",
    icon: <GlobalOutlined style={{ fontSize: "16px" }} />,
  },
  {
    value: "my-usage",
    label: "Seu Uso",
    description: "Visualizar seu próprio uso",
    icon: <UserOutlined style={{ fontSize: "16px" }} />,
    adminOnly: true,
  },
  {
    value: "organization",
    label: "Uso da Organização",
    showForAdmin: "Uso da Organização",
    showForNonAdmin: "Seu Uso na Organização",
    description: "Visualizar uso ao nível da organização",
    descriptionForAdmin: "Visualizar uso em todas as organizações",
    descriptionForNonAdmin: "Visualizar o uso da sua organização",
    icon: <BankOutlined style={{ fontSize: "16px" }} />,
  },
  {
    value: "team",
    label: "Uso da Equipe",
    description: "Visualizar uso por equipe",
    icon: <TeamOutlined style={{ fontSize: "16px" }} />,
  },
  {
    value: "customer",
    label: "Uso do Cliente",
    description: "Visualizar uso por contas de clientes",
  ...
  {
    value: "agent",
    label: "Uso do Agente (A2A)",
    description: "Visualizar uso por agentes de IA",
    icon: <RobotOutlined style={{ fontSize: "16px" }} />,
    adminOnly: true,
  },
  {
    value: "user",
    label: "Uso do Usuário",
    description: "Visualizar uso por usuário",
    icon: <UserOutlined style={{ fontSize: "16px" }} />,
    adminOnly: true,
  },
  {
    value: "user-agent-activity",
    label: "Atividade do Usuário e Agente",
    description: "Visualizar atividade entre usuários e agentes",
    icon: <UserOutlined style={{ fontSize: "16px" }} />,
  },
];

...
const ModelRetrySettingsTab = ({
  ...
  return (
    <TabPanel>
      ...
      {isGlobalScope ? (
        <>
          <Title>{t("modelRetrySettings.globalTitle")}</Title>
          <Text className="mb-6">{t("modelRetrySettings.globalSubtitle")}</Text>
        </>
      ) : (
        <>
          <Title>{t("modelRetrySettings.groupTitle", { group: selectedModelGroup })}</Title>
          <Text className="mb-6">{t("modelRetrySettings.groupSubtitle")}</Text>
        </>
      )}
      <table>
        <tbody>
                ...
                <td>
                  ...
                  {!isGlobalScope && (
                    <Text className="text-xs text-gray-500 ml-2">
                      {t("modelRetrySettings.globalInherited", { value: inheritedValue })}
                    </Text>
                  )}
                </td>

...
class Logging(LiteLLMLoggingBaseClass):
    ...
    def _response_cost_calculator(
        ...
        try:
            ...
            additional_response_cost: object = self.model_call_details.get(
    ...
    def _generate_content_result_as_model_response(
        ...
        try:
            ...
            Exception
        ) as e:  # noqa: BLE001 - cost normalization must never break the response path
            verbose_logger.debug(
                f"generate_content response cost normalization failed: {e}"
            )
            return None

...
class ModelInfoBase(ProviderSpecificModelInfo, total=False):
    ...
    input_cost_per_video_token: Optional[
        float
    ]  # for gemini omni models with video input
    ...
    output_cost_per_video_token: Optional[
        float
    ]  # for gemini omni models with video output
...
def shared_backend_model_info(model_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    return {
        k: v for k, v in model_info.items() if k in SHARED_BACKEND_MODEL_INFO_FIELDS
    }
